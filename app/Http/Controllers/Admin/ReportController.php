...
class ReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $isAdmin = $currentUser->hasRole('admin') || $currentUser->username === 'admin' || $currentUser->email === 'admin@nexuscommunity.id';
        if (!$isAdmin) {
    ...
    public function exportExcel(Request $request)
    {
        ...
        $html .= '<div class="title">LAPORAN ' . strtoupper($type) . ' - nexuscommunity.id (' . date('d/m/Y H:i') . ')</div>';
        $html .= '<table>';
