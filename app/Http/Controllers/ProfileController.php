...
class ProfileController extends Controller
{
    ...
    {
        $user = $request->user();
        $isAdmin = ($user->username === 'admin' || $user->email === 'admin@nexuscommunity.id');
        if (!$isAdmin) {
            try {
        ...
        return Inertia::render('Profile/Edit', [
            ...
            'company_profile' => [
                'name' => $settings['company_name'] ?? 'PT.Nexus Community Punya Kita',
                'owner' => $settings['company_owner'] ?? 'PT.Nexus Community Punya Kita',
                'copyright' => $settings['company_copyright'] ?? 'PT.Nexus Community Punya Kita Corp. Hak Cipta Dilindungi Undang-Undang.',
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        if ($isAdmin) {
            Setting::setValue('company_name', $validated['company_name'] ?? 'PT.Nexus Community Punya Kita', 'text');
            Setting::setValue('company_owner', $validated['company_owner'] ?? 'PT.Nexus Community Punya Kita', 'text');
            Setting::setValue('company_copyright', $validated['company_copyright'] ?? 'PT.Nexus Community Punya Kita Corp. Hak Cipta Dilindungi Undang-Undang.', 'text');
