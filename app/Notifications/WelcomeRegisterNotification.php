...
class WelcomeRegisterNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $mail = (new MailMessage)
            ->subject('Selamat Datang di talenta52.id - Akun Anda Berhasil Terdaftar!')
            ->greeting('Halo ' . $this->user->name . ',')
            ->line('Selamat datang di **talenta52.id** (E-Commerce Trade Promotion Program).')
        ...
        return $mail
            ...
            ->line('Terima kasih telah bergabung bersama talenta52.id!');
    }
}
