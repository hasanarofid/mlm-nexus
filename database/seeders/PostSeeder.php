...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Post::updateOrCreate(
            ['slug' => 'mengenal-program-kemitraan-dan-komisi-unilevel-nexus-community'],
            [
                'category_id' => $catBisnis->id,
                'title' => 'Mengenal Program Kemitraan dan Komisi Unilevel NEXUS COMMUNITY',
                'content' => "Selamat datang di NEXUS COMMUNITY — Platform kemitraan modern dengan semangat Saling Bantu, Manfaat Bersama.\n\nNEXUS COMMUNITY dirancang untuk memberikan kesempatan penghasilan yang adil dan transparan bagi setiap mitra. Melalui sistem jaringan Unilevel Multi-Tier Generasi 1 hingga 10, setiap pendaftaran mitra baru memberikan bonus Rp 7.000 untuk setiap tingkatan upline di atasnya.\n\n## Formula Pembagian Bonus:\n- 50% Auto Save (Rp 3.500): Ditabung secara otomatis untuk ketahanan aset masa depan mitra.\n- 50% Saldo WD (Rp 3.500): Saldo siap ditarik (cashout) langsung ke rekening bank mitra.\n\n> Bersama NEXUS COMMUNITY, kita wujudkan kemandirian finansial melalui ekosistem yang saling menguatkan dan berkelanjutan.",
                'image' => null,
                'status' => 'published',
                'is_featured' => true
            ]
