...
<template>
  <Head title="Fitur TPR (Trade Promotion Program) - NEXUS COMMUNITY" />
      ...
      <div class="bg-gradient-to-r from-amber-600 via-amber-700 to-yellow-600 rounded-3xl p-6 md:p-8 text-white shadow-lg space-y-4 relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          ...
          <div class="p-3 bg-white/10 backdrop-blur rounded-2xl border border-white/20 space-y-1">
            ...
            <p class="text-xs text-white font-bold">Bagi Hasil User: <span class="text-amber-200">Rp 945.000 / Bulan</span></p>
